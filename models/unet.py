...
# Code adapted from repo https://github.com/NischalSuresh/Lung-segmentation.git
...
class UNet(torch.nn.Module):
    ''' - Takes number of i/p and o/p channels as constructor arguments \n
    - returns feature map of same input shape but with o/p channels
    - o/p channels - 128 as per paper'''
...
class PretrainedUNet(torch.nn.Module):
    ...
    - returns feature map of same input shape but with o/p channels
    - o/p channels - 128 as per paper
    - Uses pretrained VGG11 layer weights in Unet encoder'''
